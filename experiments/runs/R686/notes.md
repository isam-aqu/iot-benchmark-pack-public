## R686 - W3 Zigbee AP-Channel Extension
...
```bash
python3 python/summarize_w3_run.py experiments/runs/R686/raw --run-id W3_zigbee_auto_baseline_ch1 --expected-events 100
python3 python/analyze_w3_run.py experiments/runs/R686/raw --run-id R686 --run-sheet docs/run_sheet.csv
```
